    ...
    <div class="row" style="margin: 12px -1px">
        <div class="col-12">
            <ul class="nav nav-tabs" id="lessonTab" role="tablist">
                 <li>
                  <?php
                  $assigments = $this->crud_model->get_assigment('course', $course_details['id'])->result_array();?>
                      
                  <h5><?php echo site_phrase('assignment'); ?></h5>
                  <?php foreach ($assigments as $key => $assigment):?>
                      <div class="already_purchased">
                        <a href="<?php echo $assigment['link']; ?>"><?php echo site_phrase('click_here'); ?></a>
                      </div>
                  <?php endforeach; ?>
                </li>
            </ul>
