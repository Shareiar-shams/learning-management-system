...
$assigments = $this->crud_model->get_assigment('course', $course_id)->result_array();
?>
<div class="row justify-content-center">
    <div class="col-xl-12 mb-4 text-center mt-3">
        ...
        <a href="javascript::void(0)" class="btn btn-outline-primary btn-rounded btn-sm ml-1" onclick="showAjaxModal('<?php echo site_url('modal/popup/assigment_add/'.$course_id); ?>', '<?php echo get_phrase('add_new_assignment'); ?>')"><i class="mdi mdi-plus"></i> <?php echo get_phrase('add_assigment'); ?></a>
    ...
    <div class="col-xl-8">
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card bg-light text-seconday on-hover-action mb-5" id = "section-<?php echo $assigment['id']; ?>">
                    <div class="card-body">
                        <h5 class="card-title" class="mb-3" style="min-height: 45px;"><span class="font-weight-light"><?php echo get_phrase('assigment_link'); ?></span>: <?php echo $assigment['link']; ?>
                            <div class="row justify-content-center alignToTitle float-right display-none" id = "widgets-of-section-<?php echo $assigment['id']; ?>">
                                <button type="button" class="btn btn-outline-secondary btn-rounded btn-sm ml-1" name="button" onclick="showAjaxModal('<?php echo site_url('modal/popup/assigment_edit/'.$assigment['id'].'/'.$course_id); ?>', '<?php echo get_phrase('update_assigment_link'); ?>')" ><i class="mdi mdi-pencil-outline"></i> <?php echo get_phrase('edit_assigment'); ?></button>
                                <button type="button" class="btn btn-outline-secondary btn-rounded btn-sm ml-1" name="button" onclick="confirm_modal('<?php echo site_url('admin/assigments/'.$course_id.'/delete'.'/'.$assigment['id']); ?>');"><i class="mdi mdi-window-close"></i> <?php echo get_phrase('delete_assigment'); ?></button>
                            </div>
                        </h5>
                    </div> <!-- end card-body-->
            </div>
