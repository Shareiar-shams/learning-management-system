...
class Admin extends CI_Controller
{
    ...
    public function assigments($param1 = "", $param2 = "", $param3 = "")
    {
        if ($this->session->userdata('admin_login') != true) {
            redirect(site_url('login'), 'refresh');
        }
        ...
        if ($param2 == 'add') {
            $this->crud_model->add_assigment($param1);
            $this->session->set_flashdata('flash_message', get_phrase('assigment_has_been_added_successfully'));
        } elseif ($param2 == 'edit') {
            $this->crud_model->edit_assigment($param3);
            $this->session->set_flashdata('flash_message', get_phrase('assigment_has_been_updated_successfully'));
        } elseif ($param2 == 'delete') {
            $this->crud_model->delete_assigment($param3);
            $this->session->set_flashdata('flash_message', get_phrase('assigment_has_been_deleted_successfully'));
        }
        redirect(site_url('admin/course_form/course_edit/' . $param1));
    }
